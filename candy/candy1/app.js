...
var chosenXAxis = "Top Candy";  // Default initial x-axis label
var chosenYAxis = "Top Candy pounds";  // Default initial y-axis label
var xAxisLabels = ["Top Candy", "2nd Place", "3rd Place"];  // Default 
var yAxisLabels = ["Top Candy pounds", "2nd Place pounds", "3rd Place pounds"];
var labelsTitle = { "Top Candy": "Which Candy Sold", 
                    "2nd Place": "Which Candy Sold", 
                    "3rd Place": "Which Candy Sold",
                    "Top Candy pounds": "Most Candy Sold", 
                    "2nd Place pounds": "2nd Most Candy Sold", 
                    "3rd Place pounds": "3rd Most Candy Sold" };
var axisPadding = 20;
...
d3.csv("/state-candy.csv").then((data, error) => {
    ...
    data.forEach(d => {
      ...
      d["2nd Place"] = d["2nd Place"];
      d["3rd Place"] = d["3rd Place"];
    });
